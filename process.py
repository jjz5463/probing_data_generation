...
def split_examples(example, index, sentence_per_class):
    ...
    if 0 <= index < sentence_per_class:
        ...
        split_sentences = re.split(r'\s*Informal:? ', generated_sentences, flags=re.IGNORECASE)
        ...
        split_sentences = re.split(r'\s*Simple:? ', generated_sentences, flags=re.IGNORECASE)
        ...
        split_sentences = re.split(r'\s*Without contraction:? ', generated_sentences, flags=re.IGNORECASE)
        ...
        split_sentences = re.split(r'\s*Without number substitution:? ', generated_sentences, flags=re.IGNORECASE)
